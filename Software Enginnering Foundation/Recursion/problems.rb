...
def reverse_string(str)
    ...
    str[str.length - 1] + reverse_string(str[0..(str.length - 2)])

end
#puts reverse_string("")
# ("")
#puts reverse_string("c")
# ("c")
#puts reverse_string("internet")
# ("tenretni")
#puts reverse_string("abbbcdef")
# ("fedcbbba")
...
def flatten(data)
    ...
    flatten(data[0]) + flatten(data[1..(data.length-1)])
...
#puts
#array_1 = [1, 2, [[3, 4], [5, [6]]], [7, 8]]
#print flatten(array_1)
# ([ 1, 2, 3, 4, 5, 6, 7, 8 ])
#puts
#array_2 = ['this', ['problem', 'is'], [['pretty', 'tough'], [[':)']]]]
#print flatten(array_2)
